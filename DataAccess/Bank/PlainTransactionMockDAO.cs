...
{
    public class PlainTransactionMockDAO : ITransactionDAO
    {
        public IEnumerable<ITransaction> GetTransactionsByDate(DateTime startDateWillBeIgnored, DateTime endDateWillBeIgnored)
        {
